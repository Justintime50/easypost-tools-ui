<div class="modal fade" id="createToAddress" tabindex="-1" role="dialog" aria-labelledby="createToAddressLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="createToAddressLabel">Create Address</h5>
