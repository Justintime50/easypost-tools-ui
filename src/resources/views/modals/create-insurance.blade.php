<div class="modal fade" id="createInsurance" tabindex="-1" role="dialog" aria-labelledby="createInsuranceLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="createInsuranceLabel">Create Insurance</h5>
