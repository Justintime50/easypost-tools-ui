...
@section('content')
    ...
    <div class="container">
        ...
        <form action="/update-api-key" method="POST">
            @csrf
            <p>You can add your test or production EasyPost API key here. API keys will be masked and cannot be retrieved here. Treat these keys the same way you would a password!</p>
            <p>You can access your EasyPost API keys by visiting the <a href="https://easypost.com/account" target="_blank">EasyPost Dashboard</a>.</p>
