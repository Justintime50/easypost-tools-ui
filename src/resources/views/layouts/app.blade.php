            ...
            <div class="list-group list-group-flush">
                ...
                <div class="collapse" id="carriersCollapse">
                    <form action="/retrieve-carriers" method="POST" id="retrieveCarriers">
                        @csrf
                        <a href="#" data-toggle="modal" data-target="#retrieveCarrier" class="nav-link">Retrieve Carrier
                            Account</a>
                ...
                <div class="collapse" id="insuranceCollapse">
                    ...
                    <a href="#" data-toggle="modal" data-target="#retrieveInsurance" class="nav-link">Retrieve
                        Insurance</a>
                ...
                <a class="list-group-item list-group-item-action bg-light" data-toggle="collapse" href="#ordersCollapse"
                    role="button" aria-expanded="false" aria-controls="ordersCollapse"><i
                        class="fas fa-layer-group"></i>&nbsp;&nbsp;Orders</a>
                <div class="collapse" id="ordersCollapse">
                    <a href="#" class="nav-link">Not Currently Supported via UI</a>
                </div>

                <a class="list-group-item list-group-item-action bg-light" data-toggle="collapse" href="#parcelCollapse"
                    role="button" aria-expanded="false" aria-controls="parcelCollapse"><i
                ...
                <div class="collapse" id="shipmentCollapse">
                    ...
                    <a href="#" data-toggle="modal" data-target="#retrieveShipment" class="nav-link">Retrieve
                        Shipment</a>
